...
<html lang="en" dir="ltr" class="landing-pages">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="../landing-pages/assets/css/landing-pages.min.css">  </head>
        ...
        <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar header-hover-menu">
            <div class="container-fluid navbar-inner">
              <div class="d-flex align-items-center justify-content-between w-100 landing-header">
                  <a href="../landing-pages/index.html" class="navbar-brand m-0 d-xl-flex d-none">
                      <!--Logo start-->
                     ...
                     <div class="d-flex align-items-center d-xl-none">
                        ...
                        <a href="../landing-pages/index.html" class="navbar-brand ms-3  d-xl-none">
                              <!--Logo start-->
                              <svg class="icon-30 text-primary" width="30"  viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect x="-0.757324" y="19.2427" width="28" height="4" rx="2" transform="rotate(-45 -0.757324 19.2427)" fill="currentColor"></rect>
                                  <rect x="7.72803" y="27.728" width="28" height="4" rx="2" transform="rotate(-45 7.72803 27.728)" fill="currentColor"></rect>
                    ...
                    <ul class="navbar-nav iq-nav-menu  list-unstyled" id="header-menu">
                      <li class="nav-item ">
                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                <li class="nav-item"><a class="nav-link active" href="../landing-pages/index.html">App Landing Page</a></li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item"><a class="nav-link " href="../landing-pages/about.html">About Us </a></li>
                        <li class="nav-item"><a class="nav-link " href="../landing-pages/feature.html"> Features </a></li>
                        <li class="nav-item"><a class="nav-link " href="../landing-pages/pricing.html">Pricing</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link " href="../landing-pages/contact-us.html">Contact Us</a></li>
                    </ul>
                  </div> <!-- container-fluid.// -->
                </nav>
          <!-- Sidebar Menu End -->
...
<div class="bg-white pb-5">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 ">
                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elementum ac integer semper sit
            ...
            <div class="col-md-8 mb-3 mt-4 mt-md-0">
                <img src="../landing-pages/assets/images/home-4/banner-left.webp" alt="" class="img-fluid ">
            </div>
            <div class="col-md-4 mb-3">
                <img src="../landing-pages/assets/images/home-4/banner-right.webp" alt="" class="img-fluid ">
            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <p class="mb-0">It is a long established fact that a reader will be distracted by the readable content
                    of a page when looking at its layout. </p>
                <a  href="#" class="btn btn-primary mt-4">Know More</a>
                <img src="../landing-pages/assets/images/home-4/service.webp" alt="" class="img-fluid mt-4">
            </div>
            <div class="col-md-6">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <p class="mb-4">Orci ipsum tempus amet libero turpis enim sed quis. Maecenas suspendisse ac integer
            ...
            <div class="col-md-6 mt-4 mt-md-0">
                <img src="../landing-pages/assets/images/home-4/Image-1.webp" alt="" class="img-fluid ">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 align-items-center ">
            <div class="col mb-md-0 mb-5">
                <img src="../landing-pages/assets/images/home-1/07.webp" alt="client-details" class="img-fluid client-img" loading="lazy">
            </div>
            <div class="col mb-md-0 mb-5">
                <img src="../landing-pages/assets/images/home-1/08.webp" alt="client-details" class="img-fluid client-img" loading="lazy">
            </div>
            <div class="col mb-md-0 mb-5">
                <img src="../landing-pages/assets/images/home-1/09.webp" alt="client-details" class="img-fluid client-img" loading="lazy">
            </div>
            <div class="col mb-md-0 mb-5">
                <img src="../landing-pages/assets/images/home-1/10.webp" alt="client-details" class="img-fluid client-img" loading="lazy">
            </div>
            <div class="col">
                <img src="../landing-pages/assets/images/home-1/11.webp" alt="client-details" class="img-fluid client-img" loading="lazy">
            </div>
        </div>
    </div>
</div>
<div class="section-card-padding">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12 text-center">
                ...
                <h2 class="mb-5 text-secondary">What our <span class="text-primary">Customer’s are saying</span></h2>
            </div>
            <div class="overflow-hidden slider-circle-btn" id="testimonial-one-slider">
                <ul class="p-0 m-0  swiper-wrapper list-inline">
                    <li class="swiper-slide card-slide card overflow-hidden ">
                        <div class=" position-relative">
                            <div class="shape">
                                <img src="../landing-pages/assets/images/home-2/shape.webp" alt="01" class="img-fluid">
                            </div>
                            <div class="card-body position-relative">
                                <h6 class="mb-3 mt-3">A true game changer.</h6>
                                <p>“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vitae, eget condimentum
                                                luctus nec nec tellus sem sed. Diam elementum tellus posuere ipsum tortor.”</p>
                                <div class="border-bottom"></div>
                                <div class="d-flex align-items-center mt-3">
                                    <img src="../landing-pages/assets/images/home-2/user-1.webp" alt="01" class="img-fluid  rounded-pill">
                                    <div class="ms-3">
                                        <p class="mb-2">Eleen Rogers</p>
                                        <div class="d-flex align-items-center">
                                                        ...
                                                        <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="none">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.1043 4.17701L14.9317 7.82776C15.1108 8.18616 15.4565 8.43467 15.8573 8.49218L19.9453 9.08062C20.9554 9.22644 21.3573 10.4505 20.6263 11.1519L17.6702 13.9924C17.3797 14.2718 17.2474 14.6733 17.3162 15.0676L18.0138 19.0778C18.1856 20.0698 17.1298 20.8267 16.227 20.3574L12.5732 18.4627C12.215 18.2768 11.786 18.2768 11.4268 18.4627L7.773 20.3574C6.87023 20.8267 5.81439 20.0698 5.98724 19.0778L6.68385 15.0676C6.75257 14.6733 6.62033 14.2718 6.32982 13.9924L3.37368 11.1519C2.64272 10.4505 3.04464 9.22644 4.05466 9.08062L8.14265 8.49218C8.54354 8.43467 8.89028 8.18616 9.06937 7.82776L10.8957 4.17701C11.3477 3.27433 12.6523 3.27433 13.1043 4.17701Z" stroke="#FFD329" stroke-linecap="round" stroke-linejoin="round"/>
                                                        </svg>
                                        </div>
                                    </div>
                                </div> 
                    ...
                    <li class="swiper-slide card-slide card overflow-hidden ">
                        <div class=" position-relative">
                            <div class="shape">
                                <img src="../landing-pages/assets/images/home-2/shape.webp" alt="02" class="img-fluid">
                            </div>
                            <div class="card-body position-relative">
                                <h6 class="mb-3 mt-3">Best you can Get</h6>
                                <p>“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vitae, eget condimentum
                                                luctus nec nec tellus sem sed. Diam elementum tellus posuere ipsum tortor.”</p>
                                <div class="border-bottom"></div>
                                <div class="d-flex align-items-center mt-3">
                                    <img src="../landing-pages/assets/images/home-2/user-2.webp" alt="02" class="img-fluid  rounded-pill">
                                    <div class="ms-3">
                                        <p class="mb-2">Brooklyn Simmons</p>
                                        <div class="d-flex align-items-center">
                                                        <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="none">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.1043 4.17701L14.9317 7.82776C15.1108 8.18616 15.4565 8.43467 15.8573 8.49218L19.9453 9.08062C20.9554 9.22644 21.3573 10.4505 20.6263 11.1519L17.6702 13.9924C17.3797 14.2718 17.2474 14.6733 17.3162 15.0676L18.0138 19.0778C18.1856 20.0698 17.1298 20.8267 16.227 20.3574L12.5732 18.4627C12.215 18.2768 11.786 18.2768 11.4268 18.4627L7.773 20.3574C6.87023 20.8267 5.81439 20.0698 5.98724 19.0778L6.68385 15.0676C6.75257 14.6733 6.62033 14.2718 6.32982 13.9924L3.37368 11.1519C2.64272 10.4505 3.04464 9.22644 4.05466 9.08062L8.14265 8.49218C8.54354 8.43467 8.89028 8.18616 9.06937 7.82776L10.8957 4.17701C11.3477 3.27433 12.6523 3.27433 13.1043 4.17701Z" fill="#FFD329"/>
                                                        </svg>
                    ...
                    <li class="swiper-slide card-slide card overflow-hidden ">
                        <div class=" position-relative">
                            <div class="shape">
                                <img src="../landing-pages/assets/images/home-2/shape.webp" alt="03" class="img-fluid">
                            </div>
                            <div class="card-body position-relative">
                                <h6 class="mb-3 mt-3">Perfect poduct for your
                                                business</h6>
                                <p>“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vitae, eget
                                                condimentum luctus nec nec tellus sem sed. Diam elementum tellus posuere ipsum tortor.”</p>
                                <div class="border-bottom"></div>
                                <div class="d-flex align-items-center mt-3">
                                    <img src="../landing-pages/assets/images/home-2/user-3.webp" alt="03" class="img-fluid  rounded-pill">
                                    <div class="ms-3">
                                        <p class="mb-2">Jenny Wilson</p>
                                        <div class="d-flex align-items-center">
                                                        <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="none">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.1043 4.17701L14.9317 7.82776C15.1108 8.18616 15.4565 8.43467 15.8573 8.49218L19.9453 9.08062C20.9554 9.22644 21.3573 10.4505 20.6263 11.1519L17.6702 13.9924C17.3797 14.2718 17.2474 14.6733 17.3162 15.0676L18.0138 19.0778C18.1856 20.0698 17.1298 20.8267 16.227 20.3574L12.5732 18.4627C12.215 18.2768 11.786 18.2768 11.4268 18.4627L7.773 20.3574C6.87023 20.8267 5.81439 20.0698 5.98724 19.0778L6.68385 15.0676C6.75257 14.6733 6.62033 14.2718 6.32982 13.9924L3.37368 11.1519C2.64272 10.4505 3.04464 9.22644 4.05466 9.08062L8.14265 8.49218C8.54354 8.43467 8.89028 8.18616 9.06937 7.82776L10.8957 4.17701C11.3477 3.27433 12.6523 3.27433 13.1043 4.17701Z" fill="#FFD329"/>
                                                        </svg>
    ...
    <div id ="back-to-top" style="display: none;">
     ...
     <a class="btn btn-fixed-end btn-primary btn-icon btn-landing" href="../dashboard/index.html">
      Dashboard Demo
    </a>
    ...
    <script src="../assets/vendor/swiperSlider/swiper-bundle.min.js"></script>
     <script src="../landing-pages/assets/js/app-landing.js" defer></script>  </body>
</html>
